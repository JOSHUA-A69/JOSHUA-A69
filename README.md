<div style="font-family: 'Georgia', serif; background-color: #f0f0f0; max-width: 800px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
  ...
  <div style="border: 2px solid #e0e0e0; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
    ...
    <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
      ...
      <a href="https://www.w3schools.com/php/default.asp" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/php/php-original.svg" alt="PHP" style="width: 35px; height: 35px; transition: transform 0.3s ease;"></a>
  ...
  <div style="border: 2px solid #e0e0e0; padding: 15px; border-radius: 8px;">
    ...
    <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
      ...
      <a href="https://www.apachefriends.org/index.html" target="_blank" rel="noreferrer"><img src="https://i.postimg.cc/7PpWvcdY/XAMPP-logo.png" alt="XAMPP" style="width: 35px; height: 35px; transition: transform 0.3s ease;"></a>
